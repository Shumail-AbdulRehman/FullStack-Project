...
import { MoreVertical, Trash2, Pencil, Heart } from 'lucide-react'; // Added Heart
...
function Video() {
  ...
  const { data: comments, isLoading: commentsLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      console.log("comments are::",res.data.data.docs);
  ...
  const { mutate: toggleLike } = useMutation({
    mutationFn: async (commentId) => {
      ...
      console.log("toggle like ran",res.data)
      return res.data;
    },
    onSuccess: () => {
      // This forces the comments to reload to show the new like count/state
  ...
  if (isError) {
    return (
      <div className="grid grid-cols-6 gap-0 min-h-screen bg-[#0f0f0f] text-white">
  ...
  if (!video || !video.video || !video.video[0]) {
    return <div className="text-white p-10">No video data found</div>;
  }
                    ...
                    {editingCommentId === comment._id ? (
                      ...
                      <div className="flex gap-4 items-start w-full">
                        ...
                        <div className="flex flex-col gap-1 w-full relative">
                          ...
                          {/* LIKE BUTTON SECTION ADDED HERE */}
                          <div className="flex items-center gap-2 mt-1.5">
                              ...
                              >
                                ...
                                />
                                {/* Optional: Show count if available in your aggregation */}
