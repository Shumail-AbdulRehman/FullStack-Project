...
function VideoListing() {
    ...
    useEffect(()=>
    {
        ...
        {
           try {
             const fetchVideos=await axios.get(`${import.meta.env.VITE_API_URL}/api/v1/videos/`,{withCredentials:true})
    ...
    {
        return(
                <h1 className='bg-white text-black'>no videos to show</h1>
        )
    }
