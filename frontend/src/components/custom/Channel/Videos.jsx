    ...
    {preview &&
      (accept.includes('video') ? (
        <video
          src={preview}
          controls
          className="w-full h-48 rounded-lg object-cover border border-zinc-700 bg-black mt-2"
        />
      ) : (
        <img
          src={preview}
          className="w-full h-48 rounded-lg object-cover border border-zinc-700 mt-2"
        />
      ))}
  </div>
);
